...
export default function AddQuestion() {
  ...
  const fetchExamData = async () => {
    try {
      const res = await axios.get(`https://ipt-pit-lgr4.onrender.com/api/exams/${examId}/`, { headers });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(`https://ipt-pit-lgr4.onrender.com/api/questions/${editingId}/`, { ...newQuestion, exam: examId }, { headers });
      } else {
        await axios.post(`https://ipt-pit-lgr4.onrender.com/api/questions/`, { ...newQuestion, exam: examId }, { headers });
      }
      handleCancelEdit();
      fetchExamData();
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://ipt-pit-lgr4.onrender.com/api/questions/${deleteQuestionId}/`, { headers });
