...
import { LogOut, User } from "lucide-react-native"; // Imported User icon to match dashboard style
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        {/* 🔮 CORE ADMIN PROFILE HEADER PANEL (Synced directly with Dashboard style) */}
        ...
        <View style={styles.headerBanner}>
          ...
          <View style={styles.badge}>
            <Text style={styles.badgeText}>Administrator Account</Text>
          </View>
        </View>
